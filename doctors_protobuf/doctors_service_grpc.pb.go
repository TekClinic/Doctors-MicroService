...
const (
	...
	DoctorService_CreateDoctor_FullMethodName  = "/doctors.DoctorService/CreateDoctor"
)
...
func (c *doctorServiceClient) CreateDoctor(ctx context.Context, in *CreateDoctorRequest, opts ...grpc.CallOption) (*DoctorID, error) {
	out := new(DoctorID)
